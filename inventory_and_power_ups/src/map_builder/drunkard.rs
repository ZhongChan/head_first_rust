...
const STAGGER_DISTNACE: usize = 400;
...
impl MapArchitect for DrunkardsWalkArchitect {
    fn new(&mut self, rng: &mut RandomNumberGenerator) -> MapBuilder {
        ...
        mb.monster_spawns = mb.spawner_monsters(&center, rng);
...
impl DrunkardsWalkArchitect {
    fn drunkard(&self, start: &Point, rng: &mut RandomNumberGenerator, map: &mut Map) {
        ...
        loop {
            ...
            distance_staggerd += 1;
            if distance_staggerd > STAGGER_DISTNACE {
                break;
            }
        }
    }
