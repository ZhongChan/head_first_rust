...
///    --> src/rust_course/10_0_lifetime.rs:156:41
///     |
...
/// ```text
/// error[E0597]: `short` does not live long enough
///    --> src/rust_course/10_0_lifetime.rs:185:30
///     |
...
///    --> src/rust_course/10_0_lifetime.rs:230:5
///     |
/// 230 |     result.as_str()
///     |     ------^^^^^^^^^
///     |     |
...
///    --> src/rust_course/10_0_lifetime.rs:306:30
///     |
